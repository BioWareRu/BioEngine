...
namespace BioEngine.Admin
{
    ...
    public class ObjectGraphFluentValidator : ComponentBase
    {
        ...
        {
            if (validationContext.Items.TryGetValue(ValidationContextValidatorKey, out var result) && result is ObjectGraphFluentValidator validator)
            {
